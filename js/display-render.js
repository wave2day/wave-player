  ...
  return `
    <svg class="lcdModeGlyph" viewBox="-20 0 260 240" aria-hidden="true">
      <path d="M 88 18 H 190 A 30 30 0 0 1 220 48 V 74 A 30 30 0 0 1 190 104 H 148"
        fill="none" stroke="currentColor" stroke-width="26" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M 92 104 H 50 A 30 30 0 0 0 20 134 V 160 A 30 30 0 0 0 50 190 H 152"
        fill="none" stroke="currentColor" stroke-width="26" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M 62 64 L 62 144 L 122 104 Z" fill="currentColor"/>
      <path d="M 178 64 L 178 144 L 118 104 Z" fill="currentColor"/>
    </svg>
  `;
}
  ...
  const repeatBase = `
    <svg class="lcdModeGlyph" viewBox="-20 0 260 240" aria-hidden="true">
      ...
      <path d="M 20 48 V 132"
        fill="none" stroke="currentColor" stroke-width="26" stroke-linecap="round"/>
      <path d="M -20 128 L 20 186 L 62 128 Z" fill="currentColor"/>
    </svg>
  `;
...
renderPlayer();  if (state.repeat === "one") {
    return `
      <div class="lcdModeOneWrap">
        ${repeatBase}
        <span class="lcdModeOne">1</span>
